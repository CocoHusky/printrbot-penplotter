...
> **Status:** Release 1.0.6. The core text, image, preview, G-code, and ESP32 bridge workflows are usable; physical hardware still requires operator validation.

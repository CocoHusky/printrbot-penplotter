...
> **Status:** Release 1.0.9. The core text, image, preview, G-code, and ESP32 bridge workflows are usable; physical hardware still requires operator validation.

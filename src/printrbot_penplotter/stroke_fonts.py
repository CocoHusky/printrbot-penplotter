...
_ROBOT_BASE: dict[str, GlyphVariant] = {
    ...
    ".": _glyph(_stroke((0.3, 0.02), (0.31, 0.02)), advance=0.42),
    ",": _glyph(_stroke((0.3, 0.08), (0.23, -0.16)), advance=0.42),
    "!": _glyph(_stroke((0.35, 1.0), (0.35, 0.25)), _stroke((0.35, 0.03), (0.36, 0.03)), advance=0.7),
    "?": _glyph(_stroke((0.08, 0.78), (0.22, 0.98), (0.58, 1.0), (0.76, 0.8), (0.64, 0.6), (0.38, 0.48), (0.38, 0.28)), _stroke((0.38, 0.03), (0.39, 0.03)), advance=0.84),
    "-": _glyph(_stroke((0.08, 0.45), (0.7, 0.45)), advance=0.78),
    "_": _glyph(_stroke((0.05, -0.08), (0.82, -0.08)), advance=0.9),
    ":": _glyph(_stroke((0.3, 0.68), (0.31, 0.68)), _stroke((0.3, 0.15), (0.31, 0.15)), advance=0.45),
    ";": _glyph(_stroke((0.3, 0.68), (0.31, 0.68)), _stroke((0.31, 0.16), (0.22, -0.12)), advance=0.45),
...
_HAND_LOWER: dict[str, GlyphVariant] = {
    ...
    "i": _glyph(_stroke((0.02, 0.0), (0.18, 0.4), (0.21, 0.0)), _stroke((0.2, 0.66), (0.21, 0.66)), advance=0.34, entry=(0.02, 0.0), exit=(0.3, 0.0)),
    "j": _glyph(_stroke((0.02, 0.0), (0.22, 0.42), (0.2, -0.24), (0.05, -0.36), (-0.08, -0.25)), _stroke((0.22, 0.68), (0.23, 0.68)), advance=0.36, entry=(0.02, 0.0), exit=(0.31, 0.0)),

...
function renderGcodePreview(text){
 ...
 for(let userY=0;userY<=150;userY+=10){const displayY=userY;svg.push('<path d="M '+userY+' 0 V 152.4 M 0 '+displayY+' H 152.4" fill="none" stroke="#d5e0e8" stroke-width="0.18"/>');svg.push('<text x="'+(userY+0.8)+'" y="4" fill="#7890a1" font-size="2.5">'+userY+'</text>');svg.push('<text x="1" y="'+(displayY-0.8)+'" fill="#7890a1" font-size="2.5">'+userY+'</text>')}

...
function renderGcodePreview(text){
 ...
 const svg=['<svg xmlns="http://www.w3.org/2000/svg" viewBox="-18 -18 188.4 188.4">','<rect x="-16" y="-16" width="184.4" height="184.4" fill="#ffffff"/>','<rect x="0" y="0" width="152.4" height="152.4" fill="#f8fbfd" stroke="#536b7d" stroke-width="0.8"/>'];
